...
from portfotrack.cli.parsing.error_codes import CliParsingErrorCode
    ...
    def __init__(
        ...
        *,
        ...
        if reason is not None:
            message += f" {reason}"
        super().__init__(
            code=CliParsingErrorCode.CLI_INVALID_FLAG,
            message=message,
            details=details,
            cause=cause,
        )
...
class DuplicatedFlagError(CliError):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            code=CliParsingErrorCode.CLI_DUPLICATED_FLAG,
...
class MissingFlagValueError(CliError):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            code=CliParsingErrorCode.CLI_MISSING_FLAG_VALUE,
            message=message,
            details=details,
            cause=cause,
        )
